...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/gkuetenang/Projects/Tontine/public/storage' => 'string',
            ...
            'memberships.default_role' => 'string',
            'memberships.number_length' => 'integer',
            'memberships.default_member_number_prefix' => 'string',
            'permission.models.permission' => 'string',
            'permission.models.role' => 'string',
            'permission.models.team' => 'string',
...
'images.default','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.bcrypt.limit',
...
'debugbar.collectors.jobs','debugbar.collectors.pennant','debugbar.collectors.ai','debugbar.collectors.http_client','debugbar.options.time.memory_usage',
...
'debugbar.options.db.backtrace_editor_links','debugbar.options.db.timeline','debugbar.options.db.duration_background','debugbar.options.db.explain','debugbar.options.db.show_query_result',
...
'debugbar.options.ai.values','debugbar.custom_collectors','debugbar.editor','debugbar.capture_ajax','debugbar.add_ajax_timing',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/gkuetenang/Projects/Tontine/public/storage','fortify.guard','fortify.middleware',
...
'fortify.features','inertia.ssr.enabled','inertia.ssr.url','inertia.pages.paths','inertia.pages.extensions',
...
'media-library.disk_name','media-library.conversions_disk_name','media-library.max_file_size','media-library.disallowed_extensions','media-library.allowed_extensions',
...
'media-library.enable_vapor_uploads','media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','memberships.default_role',
'memberships.number_length','memberships.default_member_number_prefix','permission.models.permission','permission.models.role','permission.models.team',
'permission.models.default_model','permission.table_names.roles','permission.table_names.permissions','permission.table_names.model_has_permissions','permission.table_names.model_has_roles',
...
'session.same_site','session.partitioned','session.serialization','boost.enabled','boost.browser_logs_watcher',
...
'boost.executable_paths.current_directory','boost.browser_log_levels','passkeys.relying_party_id','passkeys.allowed_origins','passkeys.user_handle_secret',
...
'signed','throttle','verified','tontine.team',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','actions.accept','actions.action','actions.actions',
...
'actions.yes','http-statuses.0','http-statuses.100','http-statuses.101','http-statuses.102',
...
'validation.attributes.city','validation.attributes.color','validation.attributes.company','validation.attributes.compilation','validation.attributes.concept',
...
'validation.attributes.referees','validation.attributes.region','validation.attributes.reject_reason','validation.attributes.remember','validation.attributes.restored_at',
...
'validation.attributes.year','memberships.errors.membership_exists','memberships.errors.role_not_found','memberships.status.active','memberships.status.inactive',
'memberships.status.suspended','memberships.status.left',);
...
'BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','QUEUE_CONVERSIONS_BY_DEFAULT','CACHE_STORE',
