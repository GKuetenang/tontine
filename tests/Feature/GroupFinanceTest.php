...
it('builds the consolidated financial state from transactions without floats', function (): void {
    ...
    $membership = Membership::factory()->active()->create(['group_id' => $group->id]);
    ...
    $dashboard = app(BuildGroupFinancialDashboardAction::class)->execute($group);
...
it('allows an authorized president to view the group finances', function (): void {
    ...
    $this->actingAs($president)
        ->get(route('groups.finances.index', $group))
