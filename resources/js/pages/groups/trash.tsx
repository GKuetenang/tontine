...
export default withAppLayout<Props>(
    ...
    ({ collection }) => {
        ...
        return (
            <>
                <Head title={t('Corbeille des réunions')} />
                <Heading
                    title={t('Corbeille des réunions')}
                    description={t(
                        'Restaurez une réunion ou supprimez-la définitivement.',
                    )}
                />
                <Card className="bg-background pt-0">
                    <CardHeader className="border-b py-4">
                        <CardTitle>{t('Réunions supprimées')}</CardTitle>
                    </CardHeader>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead>{t('Suppression')}</TableHead>
