...
export default withAppLayout<Props>(
    ...
    ({ collection }) => {
        ...
        return (
            <AccountLayout>
                <Head title={t('Mes prêts')} />
                <Heading
                    title={t('Mes prêts')}
                    description={t(
                        'Consultez vos emprunts, leurs intérêts, remboursements et échéances.',
                    )}
                />
                <Card className="bg-background pt-0">
                    <CardHeader className="border-b py-4">
                        <CardTitle>{t('Historique des prêts')}</CardTitle>
                    </CardHeader>
                    <CardContent className="px-0">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead>{t('Intérêt')}</TableHead>
                                    <TableHead>{t('Remboursé')}</TableHead>
                        ...
                        {collection.data.length === 0 && (
                            <p className="p-8 text-center text-sm text-muted-foreground">
                                {t('Aucun prêt enregistré à votre nom.')}
                            </p>
                        )}
