...
enum GroupPermission: string
{
    ...
    */
    ...
    case ViewGroup = 'groups.view';
    case UpdateGroup = 'groups.update';
    case DeleteGroup = 'groups.delete';
    case RestoreGroup = 'groups.restore';
    case ForceDeleteGroup = 'groups.force-delete';
    case ManageGroupSettings = 'groups.settings.manage';
    ...
    */
    ...
    {
        return match ($this) {
            self::ViewGroup => __('Consulter la réunion'),
            self::UpdateGroup => __('Modifier la réunion'),
            self::DeleteGroup => __('Supprimer la réunion'),
            self::RestoreGroup => __('Restaurer la réunion'),
            self::ForceDeleteGroup => __('Supprimer définitivement la réunion'),
            self::ManageGroupSettings => __('Gérer les paramètres de la réunion'),
            ...
            self::ViewMeetings => __('Consulter les assises'),
            self::CreateMeetings => __('Créer les assises'),
            self::UpdateMeetings => __('Modifier les assises'),
            self::OpenMeetings => __('Ouvrir les assises'),
